...
public class Utils6 {
    public static Array<String> wordList = new Array<>();
    public static Array<String> wordListVN = new Array<>();
    public static void setWordList(){//thêm danh sách từ tiếng anh và tiếng việt cho từ vựng lớp 6
